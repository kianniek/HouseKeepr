...
class _PersonalBudgetViewState extends State<_PersonalBudgetView> {
  ...
  Widget _buildResultsCard(BuildContext context, PersonalBudgetState state) {
    ...
    return Column(
      ...
      children: [
        InkWell(
          onTap: () => _copyToClipboard(_contribution.toTrimmedFixed(2)),
        ...
        const SizedBox(height: 16),
        InkWell(
          onTap: () => _copyToClipboard(_leftover.toTrimmedFixed(2)),
          borderRadius: BorderRadius.circular(12),
          child: Card(
            elevation: 2,
            shape: RoundedRectangleBorder(
